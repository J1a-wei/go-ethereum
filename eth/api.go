...
func (api *DebugAPI) TraceETHTransferByBlockHash(ctx context.Context, hash common.Hash) (interface{}, error) {
	return huobi.GetTransfersByBlockHash(api.eth.blockchain.TransferLog, hash)
}

func (api *DebugAPI) TraceETHTransferByBlockNumber(ctx context.Context, number rpc.BlockNumber) (interface{}, error) {
	block := api.eth.blockchain.GetBlockByNumber(uint64(number))
	if block != nil {
...
func (api *DebugAPI) TraceETHTransferLogByBlockHash(ctx context.Context, hash common.Hash) (interface{}, error) {
	return huobi.GetTransferLogs(api.eth.blockchain.TransferLog, hash)
}

func (api *DebugAPI) TraceETHTxReceiptStatusByHash(ctx context.Context, blockHash common.Hash, txHash common.Hash) (x interface{}, err error) {
