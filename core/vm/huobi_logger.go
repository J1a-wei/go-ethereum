...
func (l *HuobiLogger) CaptureState(env *EVM, pc uint64, op OpCode, gas, cost uint64, memory *Memory, stack *Stack, contract *Contract, depth int, err error) error {
...
func (l *HuobiLogger) addLogger(tmpL *tmpLogger) {
	...
	if l.lastOp != nil &&
		...
		l.logs = append(l.logs, StructLog{l.lastOp.contract.Address(), l.lastOp.pc, l.lastOp.op, l.lastOp.gas, l.lastOp.cost, nil, 0, l.lastOp.stack, nil, l.lastOp.depth, 0,l.lastOp.err})
	}
